...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleSubmit(event) {
      ...
      var todo = Object.assign({}, this.state, { id: (0, _utils2.default)() });
      this.props.receiveTodo(todo);
      this.setState({ title: '', body: '' });
    }
  }, {
    key: 'updateVal',
    value: function updateVal(el) {
      var _this2 = this;

      return function (e) {
        return _this2.setState(_defineProperty({}, el, e.target.value));
      };
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Title:',
            _react2.default.createElement('input', { onChange: updateVal('title'), id: 'title', placeholder: 'buy milk', value: this.state.title, required: true })
          ),
          _react2.default.createElement(
            'label',
            null,
            'Body:',
            _react2.default.createElement('textarea', { onChange: updateVal('body'), id: 'body', cols: '20', rows: '5', value: this.state.body, required: true })
          ),
          _react2.default.createElement(
            'button',
